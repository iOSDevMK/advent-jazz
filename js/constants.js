...
// Artist metadata for each day with curated distractors (same gender, ethnicity, jazz vocalists)
export const dayMeta = {
  1: { singer: 'Ella Fitzgerald', distractors: ['Sarah Vaughan', 'Dinah Washington', 'Carmen McRae'] },
  2: { singer: 'Louis Armstrong', distractors: ['Nat King Cole', 'Billy Eckstine', 'Joe Williams'] },
  3: { singer: 'Nina Simone', distractors: ['Abbey Lincoln', 'Betty Carter', 'Shirley Horn'] },
  4: { singer: 'Melody Gardot', distractors: ['Madeleine Peyroux', 'Stacey Kent', 'Sophie Milman'] },
  5: { singer: 'Gregory Porter', distractors: ['Kurt Elling', 'José James', 'Theo Bleckmann'] },
  6: { singer: 'Nat King Cole', distractors: ['Johnny Hartman', 'Arthur Prysock', 'Lou Rawls'] },
  7: { singer: 'Billie Holiday', distractors: ['Anita O\'Day', 'June Christy', 'Chris Connor'] },
  8: { singer: 'Madeleine Peyroux', distractors: ['Melody Gardot', 'Sophie Milman', 'Stacey Kent'] },
  9: { singer: 'Jamie Cullum', distractors: ['Michael Bublé', 'Harry Connick Jr.', 'Peter Cincotti'] },
  10: { singer: 'Dean Martin', distractors: ['Frank Sinatra', 'Perry Como', 'Vic Damone'] },
  11: { singer: 'Norah Jones', distractors: ['Diana Krall', 'Katie Melua', 'Corinne Bailey Rae'] },
  12: { singer: 'Tony Bennett', distractors: ['Vic Damone', 'Steve Lawrence', 'Jack Jones'] },
  13: { singer: 'Michael Bublé', distractors: ['Harry Connick Jr.', 'Jamie Cullum', 'Matt Dusk'] },
  14: { singer: 'Dr. John', distractors: ['Tom Waits', 'Mose Allison', 'Jimmy Witherspoon'] },
  15: { singer: 'Jazzmeia Horn', distractors: ['Cécile McLorin Salvant', 'Samara Joy', 'Esperanza Spalding'] },
  16: { singer: 'ZAZ', distractors: ['Camille', 'Carla Bruni', 'Pauline Croze'] },
  17: { singer: 'Chet Baker', distractors: ['Mark Murphy', 'Bob Dorough', 'Blossom Dearie'] },
  18: { singer: 'Samara Joy', distractors: ['Jazzmeia Horn', 'Cécile McLorin Salvant', 'Veronica Swift'] },
  19: { singer: 'Sarah Vaughan', distractors: ['Ella Fitzgerald', 'Carmen McRae', 'Helen Merrill'] },
  20: { singer: 'Stacey Kent', distractors: ['Diana Krall', 'Jane Monheit', 'Sophie Milman'] },
  21: { singer: 'Harry Connick Jr.', distractors: ['Michael Bublé', 'Jamie Cullum', 'John Pizzarelli'] },
  22: { singer: 'Peggy Lee', distractors: ['Rosemary Clooney', 'Jo Stafford', 'Doris Day'] },
  23: { singer: 'Diana Krall', distractors: ['Norah Jones', 'Patricia Barber', 'Eliane Elias'] },
  24: { singer: 'Diane Reeves', distractors: ['Dianne Reeves', 'Cassandra Wilson', 'Dee Dee Bridgewater'] },
};
